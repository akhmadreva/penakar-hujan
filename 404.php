        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p>The page you are looking for might have been removed had its name changed or is temporarily unavailable. <a href="index.php?page=user">Return to homepage</a></p>
                </div>
            </div>
        </div>
    </div>
